                        ...
                        <div id='proCard' key={idx} className="col-md-2 m-3 proCard" >
                            <Link to={`/ProDetails/${Brand.id}`}>
                                <div className="carda position-relative p-3 w-100 ">
                                    ...
                                    <h6 className='pt-2 text-dark'>Price:{Brand.priceAfterDiscount ? <><span className=''>{Brand.priceAfterDiscount}</span><span className='px-2 text-decoration-line-through text-danger'>{Brand.price}</span></> : <span>{Brand.price}</span>}</h6>
                                </div>
                            </Link>
                        </div>
